...
<div class="brand-badge-container">
    <svg class="brand-svg-icon cctv-scan-pulse" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="50" cy="50" r="46" stroke="#38bdf8" stroke-width="3" fill="#060911"/>
        <path d="M22 52C28 35 45 28 65 29C74 29.5 82 34 85 38C75 42 66 43 55 43C42 43 32 48 22 52Z" fill="#38bdf8"/>
        <path d="M22 52C32 58 45 65 60 65C70 65 78 61 85 54C75 58 64 59 52 57C40 55 28 54 22 52Z" fill="#0284c7"/>
        <circle cx="52" cy="46" r="11" fill="#38bdf8"/>
